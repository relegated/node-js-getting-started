...
function GenerateStudyTiles(loadedKanaQuestions) {
    let returnHtml = `<h2>Study Kana:</h2><div class="container-fluid"><div class="row">`;
...
function GetStudyTileHtmlForQuestion(question) {
    ...
    returnHtml += `<div class="card-header">Romanji:<br> <strong>${question.romanji}</strong> <br></div>`;
